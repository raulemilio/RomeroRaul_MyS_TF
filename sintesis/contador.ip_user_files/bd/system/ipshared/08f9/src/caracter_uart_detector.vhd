...
entity caracter_detector is
    Port ( 
    	 clk_i:     in std_logic;
         rst_i:     in std_logic;
         data_i:    in std_logic_vector (7 downto 0); -- Dato recibido por UART (8 bits)
...
architecture caracter_detector_arq of caracter_detector is
            ...
            if valid_i = '1' then
                ...
                case data_i is
                    ...
                    when x"70" => -- "p" pausa
            				...
            				up_down_o  <= '0';
                    when others =>
                        	rst_o      <= '1';  -- cualquier caracter reinicia el contador
            				up_down_o  <= '0';
            				ena_o      <= '0';
                end case;
            end if;
